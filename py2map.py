...
class Dictomap(object):
    ...
    supports str, unicode, lists and other dict's as values
    since riak Sets does not support anything other than Registers as a value,
    we flatten and enumarate "list of dicts".
    d = {'lst':[{'a':1},{'b':2},{'c':3}]}
    becames:
